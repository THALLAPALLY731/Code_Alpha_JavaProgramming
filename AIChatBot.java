...
public class AIChatBot {
    ...
    public AIChatBot() {
        ...
        greetings = Arrays.asList("Hello!", "Hi there!", "Greetings!", "Nice to meet you!");
        farewells = Arrays.asList("Goodbye!", "See you later!", "Take care!", "Bye!");
        random = new Random();
    ...
    private String learnNewInformation(String input) {
        ...
        if (parts.length == 2) {
            ...
            return "Thank you for teaching me that " + key + " is " + value + ". I'll remember that!";
        }
